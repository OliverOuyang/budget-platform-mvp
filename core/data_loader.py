...
from core.constants import REQUIRED_SHEETS, CHANNEL_NAMES
...
# Backward compatibility — guardrail functions moved to core/guardrail
from core.guardrail import (  # noqa: F401
    DEFAULT_GUARDRAIL_THRESHOLDS,
    GUARDRAIL_REQUIRED_COLUMNS,
    GUARDRAIL_METRICS,
    validate_guardrail_structure,
    load_guardrail_data,
    validate_guardrail_flexible,
    load_guardrail_from_conversion_data,
    evaluate_guardrails,
)
